(function(a) {
    ...
    function b(a, b) {
        ...
        var e = '';
        e += 'https://api.openweathermap.org/data/2.5/forecast?', e += 'lat=' + 53.3498 + '&lon=' + -6.2603 + '&APPID=' + x, c(e)
    }
    ...
    function c(b) {
        ...
        c.onreadystatechange = function() {
            ...
            if (4 == c.readyState && 200 == c.status) {
                ...
                d.icon = h.list[0].weather[0].icon, d.conditionInt = e(h.list[0].weather[0].icon), d.city = 'Dublin', d.temp = f(h.list[0].main.temp), d.maxTemp = B[0].maxTemp, d.minTemp = B[0].minTemp, z = d.conditionInt, g(d);
